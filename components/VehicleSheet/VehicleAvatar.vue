  ...
  >
    ...
    >
      <path
        ...
        clip-rule="evenodd"
        :fill="agency.color"
        d="M32.3923 0L40.3799 13.8349C37.831 12.6571 34.9923 12 32 12C29.4095 12 26.9341 12.4925 24.6622 13.389L32.3923 0ZM32 14C35.8628 14 39.4415 15.2168 42.3735 17.288C46.9872 20.5471 50 25.9217 50 32C50 41.9411 41.9411 50 32 50C22.0589 50 14 41.9411 14 32C14 25.388 17.5651 19.6086 22.878 16.4793C25.5529 14.9038 28.6709 14 32 14Z"
      />
    </svg>
    <svg
      v-if="vehicle.properties.position.bearing"
