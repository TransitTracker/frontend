<template>
  <div class="tw:contents">
    ...
    <bottom-sheet
      tabindex="0"
      class="vehicle-sheet-bottom tw:text-neutral-10 tw:dark:text-neutral-90 tw:z-10 tw:md:hidden"
    >
      ...
      <div slot="header" class="tw:relative tw:px-4 tw:pb-2">
        <VehicleSheetHeader :vehicle="vehicle" />
      </div>
...
bottom-sheet.vehicle-sheet-bottom {
  ...
  --sheet-max-height: calc(100dvh - calc(var(--tw-spacing) * 72));
