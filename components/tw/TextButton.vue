<template>
  <component
    :is="tag"
    class="tw-overflow-hiddenfull tw:group tw:relative tw:flex tw:h-10 tw:items-center tw:text-sm tw:font-medium tw:leading-5 tw:focus:outline-hidden"
    :class="[
      buttonClasses,
  ...
  computed: {
    buttonClasses() {
      switch (this.color) {
        ...
        case 'onSecondary':
          return 'tw:text-white tw:dark:text-secondary-20'
        case 'onNavbar':
    ...
    stateLayerClasses() {
      switch (this.color) {
        ...
        case 'onSecondary':
          return 'tw:bg-white tw:dark:bg-secondary-20'
        case 'onNavbar':
          return 'tw:text-white tw:dark:text-neutral-90'
        case 'onError':
          return 'tw:bg-error-40 tw:dark:bg-error-80'
        case 'onErrorContainer':
          return 'tw:bg-error-90 tw:dark:bg-error-30'
