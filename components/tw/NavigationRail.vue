<template>
  <nav
    class="tw:fixed tw:inset-y-0 tw:left-0 tw:z-30 tw:hidden tw:h-full tw:w-20 tw:bg-neutral-99 tw:text-sm tw:font-medium tw:leading-4 tw:tracking-wider tw:dark:bg-neutral-10 tw:md:block"
  >
    <ul
      class="tw:flex tw:h-full tw:list-none tw:flex-col tw:items-center tw:gap-y-3 tw:bg-primary-40/25 tw:py-4 tw:pl-0! tw:dark:bg-primary-80/12"
    >
      <NuxtLink
        class="tw:group tw:relative tw:-m-2 tw:my-auto tw:h-14 tw:p-2 tw:text-primary-40! tw:no-underline tw:focus:outline-hidden tw:dark:text-white!"
        :to="localePath('/')"
      >
        <div
      ...
      >
        admin
        <span
          class="tw:bg-black tw:px-1 tw:py-0.5 tw:text-xs tw:text-white tw:dark:bg-white tw:dark:text-black"
        >
          <span class="tw:inline tw:md:hidden">sm</span>
          <span class="tw:hidden tw:md:inline tw:lg:hidden">md</span>
          <span class="tw:hidden tw:lg:inline tw:xl:hidden">lg</span>
          <span class="tw:hidden tw:xl:inline tw:2xl:hidden">xl</span>
