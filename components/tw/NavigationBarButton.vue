<template>
  ...
  >
    <a
      class="tw:group tw:min-h-14 tw:text-neutral-variant-30! tw:no-underline tw:outline-hidden tw:dark:text-neutral-variant-80!"
      href="#"
      @click="navigate"
    >
      <div
      ...
      <p
        ...
        :class="[isActive && 'tw:text-secondary-10 tw:dark:text-secondary-90']"
      >
        <slot></slot>
      </p>
    </a>
