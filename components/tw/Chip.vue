<template>
  <component
    :is="tag"
    class="tw-group tw-relative tw-inline-flex tw-h-8 tw-items-center tw-gap-x-2 tw-rounded-lg tw-border tw-border-solid tw-border-neutral-variant-80 tw-px-4 tw-transition-shadow hover:tw-shadow-sm focus:tw-outline focus:tw-outline-3 focus:tw-outline-offset-2 focus:tw-outline-secondary-30 focus:dark:tw-outline-secondary-80"
    :class="[icon && 'tw-pl-2']"
  >
    <div
    ...
    <span
      class="tw-text-sm tw-font-medium tw-text-neutral-variant-30 dark:tw-text-neutral-variant-80"
    >
      <slot />
    </span>
  </component>
