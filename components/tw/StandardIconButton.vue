<template>
  <button
    class="tw:group tw:relative tw:flex tw:h-10 tw:w-10 tw:items-center tw:justify-center tw:focus:outline-hidden"
    :class="[buttonClasses]"
    :disabled="disabled"
    @click="$emit('click')"
  >
  ...
  computed: {
    buttonClasses() {
      ...
      switch (this.color) {
        ...
        case 'surface':
          return 'tw:text-neutral-10 tw:dark:text-neutral-90'
        case 'onError':
          return 'tw:text-white tw:dark:text-error-20'
        case 'onErrorContainer':
          return 'tw:text-error-10 tw:dark:text-error-90'
    ...
    stateLayerClasses() {
      ...
      switch (this.color) {
        ...
        case 'surface':
          return 'tw:group-hover:bg-neutral-99/8 tw:group-focus:bg-neutral-99/12 tw:dark:group-hover:bg-neutral-10/8 tw:dark:group-focus:bg-neutral-10/12'
        case 'onError':
          return 'tw:group-hover:bg-error-40/8 tw:group-focus:bg-error-40/12 tw:dark:group-hover:bg-error-80/8 tw:dark:group-focus:bg-error-80/12'
        case 'onErrorContainer':
          return 'tw:group-hover:bg-error-90/8 tw:group-focus:bg-error-90/12 tw:dark:group-hover:bg-error-30/8 tw:dark:group-focus:bg-error-30/12'
