<template>
  <transition
    enter-active-class="tw-transition-transform tw-duration-500 tw-ease-standard-spatial"
    enter-class="-tw-translate-x-full"
    enter-to-class="tw-translate-x-0"
    leave-active-class="tw-transition-transform tw-duration-500 tw-ease-standard-spatial"
    leave-class="tw-translate-x-0"
    leave-to-class="-tw-translate-x-full"
  >
    <section
      v-if="value"
      class="tw-fixed tw-inset-x-0 tw-inset-y-0 tw-z-20 tw-h-full tw-overflow-y-auto tw-bg-neutral-96 dark:tw-bg-neutral-10 md:tw-left-20 md:tw-w-1/2 md:tw-max-w-100 md:tw-rounded-r-2xl md:tw-shadow-lg"
    ...
    >
      ...
      >
        ...
        <TwStandardIconButton @click="$emit('input', false)">
